...
Finally, the John Hopkins data was transposed to be tidy, instead of having dates as columns in a wide dataset.  The New York Times data was already in a tidy format.  See package site for information of other functions and sources of data.
